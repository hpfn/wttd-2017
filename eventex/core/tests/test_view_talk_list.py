...
class TalkListGet(TestCase):
    def setUp(self):
        t1 = Talk.objects.create(
            title='Título da Palesta', start='10:00',
            description='Descrição da palesta.')
        t2 = Talk.objects.create(
            title='Título da Palesta', start='13:00',
            description='Descrição da palesta.')
        c1 = Course.objects.create(
            title='Título do Curso', start='09:00',
            description='Descrição do curso.', slots=200)
